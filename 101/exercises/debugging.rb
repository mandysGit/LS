...
deck.keys.each do |suit|
  pick_cards = deck[suit]
  pick_cards.shuffle!
  player_cards << pick_cards.pop
end
...
# p neutralize('These dull boring cards are part of a chaotic board game.') == 'These cards are part of a board game.'
...
def tfidf(term, document, documents)
  tfidf = tf(term, document) * idf(term, documents)

  if tfidf.infinite? || tfidf.nan?
    "The word was not found in any of the documents in the list of documents."
  else
    tfidf
  end
end
